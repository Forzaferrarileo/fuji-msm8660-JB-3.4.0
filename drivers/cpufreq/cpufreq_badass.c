...
/* Phase configurables */
#define BADASS_MAX_IDLE_COUNTER			120
#define BADASS_PHASE_2_PERCENT			70
#define BADASS_PHASE_3_PERCENT			80
#define BADASS_SEMI_BUSY_THRESHOLD		75
#define BADASS_BUSY_THRESHOLD			100
#define BADASS_DECREASE_IDLE_COUNTER		15

#ifdef CONFIG_CPU_FREQ_GOV_BADASS_GPU_CONTROL
bool gpu_busy_state;
#define BADASS_GPU_MAX_IDLE_COUNTER		600
#define BADASS_GPU_COUNTER_INCREASE		5
#define BADASS_GPU_SEMI_BUSY_THRESHOLD		90
#define BADASS_GPU_BUSY_THRESHOLD		200
